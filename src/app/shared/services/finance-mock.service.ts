...
export class FinanceMockService {
  ...
  private recurringTransactions: RecurringTransaction[] = [
    ...
    },
    {
      ...
      amount: 49.99,
      frequency: 'monthly',
      nextDate: new Date(2026, 2, 6),
    },
    {
      id: 'r6',
      merchant: 'State Farm Auto',
      category: 'Insurance',
      categoryIcon: 'shield',
      amount: 127.5,
      frequency: 'monthly',
      nextDate: new Date(2026, 2, 10),
    },
  ];
  ...
  getRecurringTransactions(): RecurringTransaction[] {
    return [...this.recurringTransactions].sort(
